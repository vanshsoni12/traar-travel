...
export default function TopHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 bg-white border-b border-slate-200/80 min-h-16 py-2 xl:py-0 flex items-center px-3 sm:px-6 lg:px-8 shadow-xs">
        <div className="flex flex-wrap xl:flex-nowrap items-center justify-between w-full gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-teal-50 border border-teal-200/70 rounded-full text-xs font-medium text-teal-900">
              ...
              <select
                ...
                className="max-w-[90px] sm:max-w-none bg-transparent font-bold text-slate-900 focus:outline-none cursor-pointer pr-1"
              >
          ...
          <div className="order-last xl:order-none basis-full xl:basis-auto xl:flex-1 min-w-0 xl:max-w-md relative" ref={searchContainerRef}>
            <form onSubmit={handleSearchSubmit} className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-20 xl:pr-8 py-1.5 text-sm bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-600 transition-all"
              />
              {searchQuery && (
                <button
                  type="button"
                  ...
                  className="absolute right-12 xl:right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 p-0.5 cursor-pointer"
                >
                  <X className="w-3.5 h-3.5" />
                </button>
              )}
            </form>
            <button type="button" onClick={() => setShowStartingPointModal(true)}
              aria-label="Change starting point" title="Change starting point"
              className="xl:hidden absolute right-1 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center text-teal-700 rounded-lg hover:bg-teal-50">
          ...
          <div className="flex shrink-0 items-center gap-0.5 sm:gap-2">
            ...
            <div className="hidden 2xl:flex items-center bg-slate-100/90 p-1 rounded-2xl border border-slate-200/80 text-xs shadow-2xs">
              <button
                type="button"
                onClick={() => {
            ...
            <div className={`hidden xl:flex 2xl:hidden items-center rounded-xl p-0.5 border text-xs transition-colors ${
              userRole === 'provider' 
            ...
            {userRole === 'provider' && (
              <button
                ...
                className="hidden 2xl:flex items-center gap-1.5 px-3 py-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-xs font-bold shadow-2xs transition-colors cursor-pointer"
            ...
            {compareListings.length > 0 && (
              <button
                ...
                className="hidden sm:flex p-1.5 text-slate-600 hover:text-slate-900 rounded-lg bg-amber-50 border border-amber-200 text-xs font-bold flex items-center gap-1"
            ...
            <div className="relative">
              ...
              {showNotifications && (
                <div className="fixed left-3 right-3 top-16 sm:absolute sm:left-auto sm:top-auto sm:right-0 mt-2 sm:w-80 bg-white rounded-xl shadow-xl border border-slate-100 p-3 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
            ...
            >
              ...
              <span className="hidden 2xl:inline">My Trip</span>
        ...
        {/* Profile Modal */}
        {showProfileModal && (
          <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-xs flex items-start sm:items-[safe_center] justify-center z-50 p-4 overflow-y-auto">
        ...
        {showStartingPointModal && (
          <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-xs flex items-start sm:items-[safe_center] justify-center z-50 p-4 overflow-y-auto">
